...
// LECTURES
// setTimeout(() => {
//   console.log("Here is a Pizza 🍕")
// }, 3000);

// setTimeout((ing1 , ing2) => {
//   console.log(`Here is a ${ing1} and a ${ing2}`)
// }, 2000,
// "cheese","spinach");

// const ingredients = ['cheese' , 'spinach' , 'piperio'];
// setTimeout((ing1, ing2, ing3) => {
//   console.log(`Here is a ${ing1}, ${ing2}, and ${ing3}`)
// }, 3000,
// ...ingredients);

// const ingredients = ['cheese' , 'spinach' , 'piperio'];
// setTimeout((...ing) => {
//   console.log(`Here is a ${ing }`)
// }, 3000,
// ...ingredients);
